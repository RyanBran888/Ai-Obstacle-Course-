...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "resume an untested state with dependency-ordered paired-lever "
            "planning and write recovery to a new file"
        ),
    )
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "resume an untested state with wipeout action safety "
            "and write recovery to a new file"
        ),
    )
    parser.add_argument(
...
def main() -> None:
    ...
    if (
        ...
        raise ValueError(
            f"{upgrade_option} needs --extend-stopped-rounds "
